...
#from utilities import mergeDictionary
...
# Change these filepaths to your local directories
...
def extension_depth_result():
    ...
    documentation_group_exts = ["md", "pdf",
                                "rst", "tex", "docx", "pptx", "bib"]
    ...
    for columnName in data_group_exts:
        ...
        try:
            ...
            df_depth_name = pd.merge(
                df_depth_name, vc, how="outer", on="depth")
